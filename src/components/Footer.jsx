...
const Footer = () => {
  ...
  return (
    <div className="bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-slate-900 via-purple-900 to-slate-900  w-full  text-gray-300">
        ...
        <div className="flex flex-wrap justify-between ">
          <div className="w-full sm:w-3/5 lg:w-2/5 pr-2">
            <AnimatedWrapper>
              ...
              <p>Thank you for visiting Portfolio.</p>
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col  gap-5 xs:gap-10 sm:gap-5 md:gap-10 justify-between">
                <div className="text-[0.9rem] font-advanced">
                  <p className="flex items-center gap-3 mb-1">
                    <GMail /> pkamal2002@gmail.com
                  </p>
                  <p className="flex items-center gap-3 ">
                    {" "}
                    <Map />
                    <span className="pt-1">Greater Noida, UP., India</span>
                  </p>
                </div>
