...
const About = () => {
  return (
    <div
      name="About"
      className=" pt-8 h-full min-h-screen w-full flex items-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-purple-900 to-slate-900"
    >
          ...
          <div className="text-gray-400 py-4 space-y-2 md:space-y-2 md:pt-8 lg:pt-12 font-semibold text-justify">
            <AnimatedWrapper>
              <p className="leading-tight">
                Aspiring Fullstack Developer, based in Greater-Noida, India.
                Currently working as FullStack Developer in Adecho Technology.
              </p>
            </AnimatedWrapper>
            <AnimatedWrapper>
              <p className="leading-tight">
            ...
            <AnimatedWrapper>
              <p className="leading-tight">
                ...
                currently pursuing Bachelor in CSE(AI) at
