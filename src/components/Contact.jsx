...
const Contact = () => {
  ...
  return (
    <div
      name="Contact"
      className="pt-10 h-full min-h-screen w-full flex items-center bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-slate-900 via-purple-900 to-slate-900 "
    >
